...
<section>
    <div class="top_tabs ranking_tabs">
     <!-- Nav tabs -->
      ...
      <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" ><a href="<?php echo site_url('ranking/parks_by_value'); ?>" ><strong>TOP 50</strong> <br />THEME PARKS BY VALUE</a></li>
        <li role="presentation" class="active"><a href="#by_att" aria-controls="by_att" role="tab" data-toggle="tab"><strong>TOP 50</strong> <br />THEME PARKS BY ATTENDANCE</a></li>
    ...
    <div class="container">
      ...
      <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane active" id="by_att">
         <div class="text-center ranking_bottom_link">
            <a target="_blank" href="<?php echo site_url('ranking/generate_ranking_by_att_pdf'); ?>" class="btn btn-default">EXPORT AS PDF</a>
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <div class="value"><?php echo htmlentities(number_format(round($park["att"],-3))); ?></div>
                </td>
            </tr>
          <?php } } ?>   
        </table>
