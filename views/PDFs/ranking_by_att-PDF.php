...
<page_header>
    ...
    <td style="text-align: right;width: 400px;" id="heading">TOP 50 PARKS BY ATTENDANCE - <?php echo date('F, Y',time()); ?></td>
    </tr>
    </table>
</page_header>
<page_footer>
...
<table id="ranking" class="table ranking-table table-bordered">
        ...
        if($parks)
        {
        echo '<tr><th>#</th><th>Park Name</th><th>Country</th><th>Brand</th><th>Year Built</th><th>Attendance</th></tr>';    
